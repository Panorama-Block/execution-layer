...
export const STAKING_POOLS: StakingPoolConfig[] = [
  ...
  },
  {
    ...
    name: "VIRTUAL/WETH Volatile",
    poolAddress: "0x21594b992F68495dD28d605834b58889d0a727c7",
    gaugeAddress: "0xBD62Cad65b49b4Ad9C7aa9b8bDB89d63221F7af5",
    tokenA: { symbol: "VIRTUAL", address: "0x0b3e328455c4059EEb9e3f84b5543F74E24e7E1b", decimals: 18 },
  ...
  },
  {
    ...
    name: "msETH/WETH Stable",
    poolAddress: "0xDE4FB30cCC2f1210FcE2c8aD66410C586C8D1f9A",
    gaugeAddress: "0x62940D9643a130b80CA0f8bc7e94De5b7ec496C5",
    tokenA: { symbol: "msETH", address: "0x7ba6F01772924a82d9626c126347A28299E98c98", decimals: 18 },
    tokenB: { symbol: "WETH", address: "0x4200000000000000000000000000000000000006", decimals: 18 },
    stable: true,
    rewardToken: { symbol: "AERO", address: "0x940181a94A35A4569E4529A3CDfB74e38FD98631", decimals: 18 },
    enabled: true,
  },
  {
    ...
    name: "EURC/WETH Volatile",
    poolAddress: "0x9DFf4b5AE4fD673213502Ab8fbf6d36015efb3E1",
    gaugeAddress: "0x21D4eF9D2b66069f3307765A0349526f8E988294",
    tokenA: { symbol: "EURC", address: "0x60a3E35Cc302bFA44Cb288Bc5a4F316Fdb1adb42", decimals: 6 },
    tokenB: { symbol: "WETH", address: "0x4200000000000000000000000000000000000006", decimals: 18 },
    stable: false,
    rewardToken: { symbol: "AERO", address: "0x940181a94A35A4569E4529A3CDfB74e38FD98631", decimals: 18 },
    enabled: true,
